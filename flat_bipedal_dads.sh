...
#SBATCH --job-name=baseline_script
#SBATCH --time=24:00:00
#SBATCH --output=dads_bipedal_output
#SBATCH --error=dads_bipedal_error
...
python unsupervised_skill_learning/dads_off.py --logdir=log_dir --flagfile=configs/bipedal_dads_offpolicy.txt
